...
"Todo App" is a simple website that allow users to reacord their dayliy task.
...
2. Clone this repo in your terminal or git bash using the command
   ...
   ```
   git@github.com:melashu/Todo-App.git
   ```
...
Feel free to check the [issues page](https://github.com/melashu/Todo-App/issues).
...
- To React creater 
- To Microverse Crew 
- For [Ibaslogic](https://github.com/Ibaslogic)